...
#[derive(Debug, Parser)]
#[clap(version = "0.1.0", about = "Scafolds a component folder structure with a index export file, the component file and the unit test file", author = "Daniel Martins <mp.daniel.414@gmail.com")]
